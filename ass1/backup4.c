...
int main(int argc, char *argv[]) {
    ...
    // if (rank==0) {
    //     for (int i = 1; i < min; i++) {
    //         // printf("i %d xsize %d ysize %d answer %d\n",i,info.local_xsize,info.local_ysize, (info.local_xsize<info.local_ysize)?info.local_xsize:info.local_ysize);
    ...
    //     }
    //
    //     printf("local ended localx %d localy %d\n\n",info.local_xsize,info.local_ysize);
    // }
    //
